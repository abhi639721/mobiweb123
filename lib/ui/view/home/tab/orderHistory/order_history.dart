...
import 'package:jump_q/ui/view/commonwidget/not_found/history_not%20_found.dart';
...
class OrderHistoryPage extends StatefulWidget {
  ...
  static Future<bool?> start<bool>() {
    return navigateTo<bool>(routeName,
        currentPageTitle: "OrderHistoryPage");
  }
}
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => (orderHistoryController.isLoader.value)
          ? const Loader()
          : orderHistoryController.orderList.isEmpty?HistoryNotFound():
      SafeArea(
              child: Padding(
