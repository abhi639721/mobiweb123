...
class PrimaryElevatedBtn extends StatefulWidget {
  ...
  const PrimaryElevatedBtn(this._text, this._onClicked,
      {this.icon, this.buttonStyle, this.textStyle, this.borderRadius = 8.0, Key?key})
      :super(key: key);
  @override
...
class _PrimaryElevatedBtnState extends State<PrimaryElevatedBtn> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton(onPressed: widget._onClicked, child: _text, style:buttonStyle,);
  }
  Widget get _text {
    return Text(widget._text, style: widget.textStyle ?? const TextStyle(
