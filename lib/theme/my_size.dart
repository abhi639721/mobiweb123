...
double get size_154 =>getSize(154);
...
double get size_265 =>getSize(265);
double get size_280 =>getSize(280);
double get size_300 =>getSize(300);
double get size_320 =>getSize(320);
...
double _getHeightSize(dynamic value) {
  double unitHeightValue = (window.physicalSize.height / window.devicePixelRatio) * 0.0013;
  return unitHeightValue * value;
}
double _getWidthSize(dynamic value) {
  double unitHeightValue = (window.physicalSize.width / window.devicePixelRatio) * 0.0013;
  return unitHeightValue * value;
}